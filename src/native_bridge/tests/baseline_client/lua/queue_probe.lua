out("[BRIDGE_OBSERVER_V022] ENTER")
...
local TAG = "[BRIDGE_OBSERVER_V022] "
local TIMER_KEY = "WH3ObserverV022Journal"
...
local previous = __WH3_OBSERVER_V022_CLIENT
...
__WH3_OBSERVER_V022_CLIENT = state
...
local function start_session()
    ...
    local success, epoch, err = pcall(bridge.begin_battle, "wh3_observer_v022_" .. tostring(b))
